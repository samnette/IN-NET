...
<html lang="en-us">
  <head>
    ...
    <title>Unity WebGL Player | Juego</title>
  ...
  <body>
    ...
    <script>
      ...
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/Juego.loader.js";
      var config = {
        dataUrl: buildUrl + "/Juego.data.unityweb",
        frameworkUrl: buildUrl + "/Juego.framework.js.unityweb",
        codeUrl: buildUrl + "/Juego.wasm.unityweb",
