...
<div class="level">
    ...
    <a href="http://localhost/IN-NET/Contenido/Script/tema4.php" class="button">Ver Script</a>
        <video controls>
            <source src="http://localhost/IN-NET/Contenido/Videos/tema4.mp4" type="video/mp4">
