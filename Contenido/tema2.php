...
<div class="level">
    ...
    <a href="http://localhost/IN-NET/Contenido/Script/tema2.php" class="button">Ver Script</a>
        <video controls>
            <source src="http://localhost/IN-NET/Contenido/Videos/tema2.mp4" type="video/mp4">
